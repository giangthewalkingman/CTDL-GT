...
(cl:defmethod cl:initialize-instance :after ((m <FlatTarget>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FlatTarget)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name offboard-msg:<FlatTarget> is deprecated: use offboard-msg:FlatTarget instead.")))
...
(cl:defmethod type_mask-val ((m <FlatTarget>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader offboard-msg:type_mask-val is deprecated.  Use offboard-msg:type_mask instead.")
  (type_mask m))

(cl:ensure-generic-function 'position-val :lambda-list '(m))
(cl:defmethod position-val ((m <FlatTarget>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader offboard-msg:position-val is deprecated.  Use offboard-msg:position instead.")
  (position m))

(cl:ensure-generic-function 'velocity-val :lambda-list '(m))
(cl:defmethod velocity-val ((m <FlatTarget>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader offboard-msg:velocity-val is deprecated.  Use offboard-msg:velocity instead.")
  (velocity m))

(cl:ensure-generic-function 'acceleration-val :lambda-list '(m))
(cl:defmethod acceleration-val ((m <FlatTarget>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader offboard-msg:acceleration-val is deprecated.  Use offboard-msg:acceleration instead.")
  (acceleration m))

(cl:ensure-generic-function 'jerk-val :lambda-list '(m))
(cl:defmethod jerk-val ((m <FlatTarget>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader offboard-msg:jerk-val is deprecated.  Use offboard-msg:jerk instead.")
  (jerk m))

(cl:ensure-generic-function 'snap-val :lambda-list '(m))
(cl:defmethod snap-val ((m <FlatTarget>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader offboard-msg:snap-val is deprecated.  Use offboard-msg:snap instead.")
  (snap m))
